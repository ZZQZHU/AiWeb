...
// 封装不同的请求方法
const http = {
    get: (url:string,params:any) => request(url,'GET',false,params),
    getwithToken: (url:string,params:any) => request(url,'GET',true,params),
    post: (url:string,params:any) => request(url,'POST', false,params),
    postwithToken: (url:string,params:any) => request(url,'POST', false,params),
};
